...
10. **Every type value** is one of the four steps at 500 / 700 / 800 (§2), and the face is Roboto — bold italic serif only on lowercase algebraic variables carrying a `<var>`/`.var` marker (§2.0). No fluid sizing, no in-between weight, no third face.
