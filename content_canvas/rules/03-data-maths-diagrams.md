...
**Reference implementation: `Design Component Systems.dc.html#graph`. It measures its own contrast at render time across every hue; trust it over any number written here.**
...
**Reference implementation: `Design Component Systems.dc.html#numberline`. It measures its own contrast at render time across every hue; trust it over any number written here.**
...
**Reference implementation: `Design Component Systems.dc.html#venn`. It measures its own contrast at render time across every hue; trust it over any number written here.**
