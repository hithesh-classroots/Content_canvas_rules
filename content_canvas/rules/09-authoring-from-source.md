...
| Reserved | correct | `#2f9e44` | State only — never a referent |
| Reserved | wrong | `#c92a2a` | State only — never a referent |
...
anchors:
  ...
  misconception ...... wrong     #c92a2a
  correct path ....... correct   #2f9e44
