...
**Roboto is pinned, not inherited from the OS.** Self-hosted and subset (Latin + §13.2–13.3 glyphs) at weights 500 / 700 / 800, `font-display: swap`, with a `<link rel="preload">` so the download starts before the CSS is parsed rather than after.
...
| System font stack | A vendor's Arial or webfont is instantly visible beside native text |
...
- A non-system font visible beside native text
...
| Embedded font file | Fully | — | Delete; the system font stack is inherited |
...
A quarantined module still has to ship. Give it a **named legacy skin**: the transparent canvas, the system font, the ink and surface tokens applied at the board level, and its unreachable interior left alone.
